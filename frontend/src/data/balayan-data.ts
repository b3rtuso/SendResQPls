...
// Complete geographic + risk + prescription data for 48 barangays
// ============================================================

export const BALAYAN_CENTER = { lat: 13.9503, lng: 120.7334 };
...
// ---- Risk profile templates by geography ----
...
export const BARANGAYS: Barangay[] = [
  ...
  { name: 'Brgy. 1 (Poblacion)', lat: 13.9510, lng: 120.7320, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 2 (Poblacion)', lat: 13.9515, lng: 120.7335, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 3 (Poblacion)', lat: 13.9505, lng: 120.7340, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 4 (Poblacion)', lat: 13.9500, lng: 120.7330, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 5 (Poblacion)', lat: 13.9495, lng: 120.7345, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 6 (Poblacion)', lat: 13.9520, lng: 120.7350, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 7 (Poblacion)', lat: 13.9508, lng: 120.7355, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 8 (Poblacion)', lat: 13.9512, lng: 120.7315, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 9 (Poblacion)', lat: 13.9518, lng: 120.7310, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 10 (Poblacion)', lat: 13.9502, lng: 120.7360, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 11 (Poblacion)', lat: 13.9498, lng: 120.7365, riskProfile: { ...URBAN_PROFILE } },
  { name: 'Brgy. 12 (Poblacion)', lat: 13.9525, lng: 120.7325, riskProfile: { ...URBAN_PROFILE } },

  // COASTAL / LOWLAND (Near Balayan Bay — south)
  { name: 'Baclaran', lat: 13.9330, lng: 120.7150, riskProfile: { ...COASTAL_PROFILE } },
  { name: 'Carenahan', lat: 13.9280, lng: 120.7380, riskProfile: {
  ...
  { name: 'Duhatan', lat: 13.9300, lng: 120.7300, riskProfile: { ...COASTAL_PROFILE } },
  { name: 'Malalay', lat: 13.9320, lng: 120.7250, riskProfile: { ...COASTAL_PROFILE } },
  { name: 'Munting Tubig', lat: 13.9250, lng: 120.7350, riskProfile: {
  ...
  { name: 'Navotas', lat: 13.9200, lng: 120.7300, riskProfile: { ...COASTAL_PROFILE } },
  { name: 'Sukol', lat: 13.9350, lng: 120.7320, riskProfile: { ...COASTAL_PROFILE } },

  // HILLSIDE / NORTHERN (Higher elevation, inland)
  { name: 'Calan', lat: 13.9650, lng: 120.7450, riskProfile: { ...HILLSIDE_PROFILE } },
  { name: 'Caloocan', lat: 13.9580, lng: 120.7500, riskProfile: { ...HILLSIDE_PROFILE } },
  { name: 'Dalig', lat: 13.9700, lng: 120.7350, riskProfile: {
  ...
  { name: 'Durungao', lat: 13.9680, lng: 120.7200, riskProfile: { ...HILLSIDE_PROFILE } },
  { name: 'Lagnas', lat: 13.9750, lng: 120.7280, riskProfile: {
    fire: { riskLevel: 'MEDIUM', prescription: 'Grassland fire risk during dry season. Create firebreaks around structures. Contact BFP Balayan. Evacuate downhill if fire approaches.' },
    flood: { riskLevel: 'LOW', prescription: 'Elevated area — minimal flood risk. Watch for localized ponding after heavy rains only.' },
    medical: { riskLevel: 'LOW', prescription: 'Call MDRRMO. Remote location — hospital is 25 min away. First aid is critical. Request emergency vehicle with 4WD capability.' },
    accident: { riskLevel: 'LOW', prescription: 'Remote mountain roads. Secure scene. Call PNP. Response time may be extended — provide exact location details.' },
    typhoon: { riskLevel: 'MEDIUM', prescription: 'Exposed hilltop area. Secure structures and livestock. Evacuate to Lagnas Barangay Hall. Monitor PAGASA bulletins.' },
    landslide: { riskLevel: 'HIGH', prescription: 'Active landslide zone. EVACUATE at first sign of ground movement. Report to MDRRMO and Brgy Captain. Avoid returning until geologic survey completed.' },
  }},
  { name: 'Palikpikan', lat: 13.9720, lng: 120.7400, riskProfile: { ...HILLSIDE_PROFILE } },
  { name: 'Tactac', lat: 13.9680, lng: 120.7480, riskProfile: { ...HILLSIDE_PROFILE } },
  { name: 'Taludtud', lat: 13.9600, lng: 120.7380, riskProfile: { ...HILLSIDE_PROFILE } },

  // RURAL / MIXED (Inland, agricultural areas)
  { name: 'Calzada', lat: 13.9400, lng: 120.7280, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Canda', lat: 13.9350, lng: 120.7200, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Caybunga', lat: 13.9420, lng: 120.7150, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Cayponce', lat: 13.9600, lng: 120.7250, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Dao', lat: 13.9380, lng: 120.7420, riskProfile: {
  ...
  { name: 'Dilao', lat: 13.9450, lng: 120.7480, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Gimalas', lat: 13.9550, lng: 120.7100, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Gumamela', lat: 13.9620, lng: 120.7180, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Lanatan', lat: 13.9350, lng: 120.7450, riskProfile: {
  ...
  { name: 'Langgangan', lat: 13.9430, lng: 120.7350, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Lucban', lat: 13.9580, lng: 120.7400, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Magabe', lat: 13.9480, lng: 120.7200, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Patugo', lat: 13.9400, lng: 120.7500, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Pooc', lat: 13.9460, lng: 120.7420, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Sambat', lat: 13.9380, lng: 120.7180, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Sampaga', lat: 13.9550, lng: 120.7280, riskProfile: { ...RURAL_PROFILE } },
  { name: 'San Juan', lat: 13.9630, lng: 120.7320, riskProfile: { ...RURAL_PROFILE } },
  { name: 'San Piro', lat: 13.9560, lng: 120.7220, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Santol', lat: 13.9480, lng: 120.7380, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Tanggoy', lat: 13.9440, lng: 120.7260, riskProfile: { ...RURAL_PROFILE } },
  { name: 'Putat', lat: 13.9530, lng: 120.7150, riskProfile: { ...RURAL_PROFILE } },
];
