    ...
    <div className="mobile-shell">
      <div style={{ flex: 1, overflowY: 'auto', paddingBottom: 80 }}>
        ...
        <div style={{
          ...
          <img src="/public/logo.jpg" alt="" style={{ position: 'absolute', right: -20, top: -20, width: 120, opacity: 0.1, pointerEvents: 'none' }} />

          <div style={{ position: 'relative', zIndex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4 }}>
              <img src="/public/logo.jpg" alt="SRQ" style={{ width: 20, height: 20, borderRadius: 4 }} />
