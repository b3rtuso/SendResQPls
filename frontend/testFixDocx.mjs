...
if (docXml && !docXml.includes('xmlns:a=')) {
...
writeFileSync('scratch/test_fixed_daily.docx', generatedBuf);
console.log('✅ Generated scratch/test_fixed_daily.docx successfully!');
