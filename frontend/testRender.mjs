...
try {
  ...
  writeFileSync('scratch/test_document.xml', docXml);
  
  const generatedBuf = outZip.generate({ type: 'nodebuffer' });
  writeFileSync('scratch/test_generated_daily.docx', generatedBuf);
  console.log('✅ Generated test_generated_daily.docx successfully! Size:', generatedBuf.length);
